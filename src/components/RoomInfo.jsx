...
function RoomInfo({ showInfoPanel, setShowInfoPanel, roomInfo }) {
  return (
     <div className={`fixed right-0 top-0 px-5 h-screen w-[320px] md:w-[40%] lg:w-[40%] bg-white shadow-2xl transition-transform duration-700 z-[1000] ${showInfoPanel ? 'translate-x-0' : 'translate-x-full'}`}>
     ...
     <div className="p-4 flex flex-col gap-3 px-5 overflow-y-auto  mt-12 h-screen">
           <h2 className=" text-2xl lg:text-4xl font-semibold">{roomInfo?.name}</h2>
